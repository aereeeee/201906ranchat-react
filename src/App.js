...
const contents = [
  {
    ...
    1:1 채팅방에서 대화를 나누는 과정에서<br>
    청소년 성매매 피해자 평균 연령으로 조사된 ‘16살 여중생’이라고 밝혔습니다.<br>
    대화명은 ‘가나다라’ 같이 아무런 의미가 없는 단어를 사용했고<br>
    먼저 대화를 걸지 않고, 상대방이 걸어온 대화에만 응답했습니다.`
  },
  {
    text:`대화를 걸어온 1,034명 가운데 성적인 목적이 확인되지 않은 사람은 
    375명으로 전체의 36.3%입니다.
  ...
  },
  {
    ...
    ‘▲성매수 ▲성적 목적 만남 ▲성적 목적 채팅’이 목적으로
    성적인 목적으로 접근해왔습니다.`
  },
  {
    text:`성적인 목적으로 접근한 659명(63.7%) 가운데 
    가장 많았던 건 ‘성적인 목적의 채팅’으로 330명(31.9%)입니다.
    사진교환이나 영상통화를 요구하거나 음담패설을 하는 경우가 대부분입니다.`
  },  
  {
    text:`'성적인 목적의 만남’이 목적인 사람도 64명(6.2%)이나 됐습니다.
    성관계 등을 요구하지만 대가를 약속하지 않은 경우입니다.`
  },
  {
